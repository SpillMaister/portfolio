...
function LinkedIn({ url, testo }) {
  return (
    <a className="linkedin" href={url} target="_blank" rel="noreferrer" aria-label="Profilo LinkedIn (si apre in una nuova scheda)">
        ...
        <div className="wrap">
          <Appare>
            ...
            <div className="piede-righe">
              <a href={`mailto:${a.mail}`}>{a.mail}</a>
              <a href={`tel:${telPulito}`}>{a.telefono}</a>
              <LinkedIn url={a.linkedin} testo="LinkedIn" />
            </div>
